                                ...
                                <div class="card-body card-block">
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="category" class=" form-control-label">Name category :</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="category" name="category" placeholder="Title"
                                                   required value="${category.category}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="description_category" class=" form-control-label">Description</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="description_category" name="description_category"
                                                   placeholder="Content" value="${category.description_category}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
