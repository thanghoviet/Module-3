                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive table-responsive-data2">
                                <table class="table table-data2">
                                    ...
                                    <c:forEach var="category" items="${listCategory1}">
                                        <tbody>
                                        <tr class="spacer"></tr>
                                        <tr class="tr-shadow">
                                            <td>
                                            ...
                                            <td>
                                                <span class="block-email"><c:out value="${category.category}"/></span>
                                            </td>
                                            <td class="desc"><c:out value="${category.description_category}"/></td>
                                            <td>
                                                <div class="table-data-feature">
                                                    <a class="item" data-toggle="tooltip" data-placement="top"
                                                       title="Edit" href="/category?action=edit&id=${description_category.id}">
