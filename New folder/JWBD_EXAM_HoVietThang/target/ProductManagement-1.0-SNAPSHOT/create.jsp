                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <h3 class="title-5 m-b-35">Prouct Manager</h3>
                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="name" name="name" placeholder="name"
                                                   required value="${product.name}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="price" name="price"
                                                   placeholder="Content" value="${product.price}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="quantity" name="quantity"
                                                   placeholder="Date Time" value="${product.quantity}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="color" name="color"
                                                   placeholder="Date Time" value="${product.color}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="description" name="description"
                                                   placeholder="Date Time" value="${product.description}"
                                                   class="form-control">
                                        </div>
                                    </div>
