                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <h3 class="title-5 m-b-35">Product Manager</h3>
                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="name" name="name" placeholder="name"
                                                   required value="${product.title}" class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="quantity" name="quantity"
                                                   placeholder="price" value="${product.quantity}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="color" name="color"
                                                   placeholder="price" value="${product.color}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="description" name="description"
                                                   placeholder="price" value="${product.description}"
                                                   class="form-control">
                                        </div>
                                    </div>
