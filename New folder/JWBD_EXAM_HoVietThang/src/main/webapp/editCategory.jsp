                        ...
                        <div class="col-12 col-md-12">
                            <form action="" method="post" class="form-horizontal">
                                <div class="card-header">
                                    <strong>Edit Category Type</strong>
                                </div>
                                <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="description_category" class=" form-control-label">description_category</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="description_category" name="description_category"
                                                   placeholder="description" value="${category.description_category}"
                                                   class="form-control">
                                        </div>
                                    </div>
