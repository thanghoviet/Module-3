            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="header-wrap">
                        <form class="form-header" action="/product?action=search" method="GET">
                                ...
                                <table class="table table-data2">
                                    ...
                                    <c:forEach var="product" items="${listProduct}">
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <span class="block-email"><c:out value="${product.name}"/></span>
                                            </td>
                                            ...
                                            <td class="desc"><c:out value="${product.category.category}"/></td>
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <button class="item" data-toggle="tooltip" data-placement="top"
                                                            title="Delete">
                                                        <a href="/product?action=delete&id=${product.id}"> <i class="zmdi zmdi-delete"></i></a>
                                                        <a href="#" onclick="deleteNote(${product.id})"
